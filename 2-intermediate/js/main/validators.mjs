// Write a function that checks if it is a number.
...
// Write a function that checks if it is a string.
...
export function hasMaxLength(value) {

    // Your code

};

// Write a function that checks if the value has a valid property.
export function hasValidProperty(value, validator) {
