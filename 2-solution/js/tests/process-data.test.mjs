import { processData } from "../main/process-data.mjs";
import * as g from "../main/guards.mjs"
import * as t from "../main/transformers.mjs";
import * as v  from "../main/validators.mjs";
...
describe('processData', () => {
  ...
  test('12. filters strings with even length and no whitespace, then capitalizes them', () => {
    ...
    const [valid, invalid] = processData(data, g.isString, [v.hasEvenLength, (value) => !v.hasWhitespace(value)], t.capitalize);
  ...
  test('13. filters objects with name property and a name length > 4, then prints them', () => {
    ...
    const [valid, invalid] = processData(data, g.hasNameProperty, [(value) => v.hasMinLength(5)(value.name)], t.print('name'));
